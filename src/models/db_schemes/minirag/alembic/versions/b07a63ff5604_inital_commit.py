...
Revision ID: b07a63ff5604
Revises: 
Create Date: 2026-07-18 02:16:57.656352
...
def upgrade() -> None:
    ...
    op.create_index('ix_chunk_asset_id', 'chunks', ['chunk_assets_id'], unique=False)
