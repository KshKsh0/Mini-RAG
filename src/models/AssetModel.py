...
class AssetModel(BaseDataModel):
    ...
    async def get_all_project_assets(self ,assets_project_id :str):
        
        return await self.collection.find({

            'asset_preject_id' : ObjectId(assets_project_id) if assets_project_id is  isinstance(assets_project_id ,str) else assets_project_id
