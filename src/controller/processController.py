...
class ProcessController(BaseController):
    ...
    def get_file_extension(self, file_id:str):
        return os.path.splitext(file_id)[-1] #last value is the extension
    ...
    def get_file_loader(self , file_id:str):
        ...
        file_path = os.path.join(self.project_path , file_id) #from Base
    ...
    def get_file_content(self, file_id:str):
        ...
        if loader:
            return loader.load() #page_content and metadata about the file 
        return None 
